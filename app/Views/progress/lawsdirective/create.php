                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                 ...
                                 <div class="card card-bordered">
                                            <div class="card-inner">
                                                <form method="post" action="<?= site_url('laws') ?>" class="form-validate" enctype="multipart/form-data">
                                                    <div class="row g-gs">
                                                        <div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="karyapalika" name="karyapalika" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <option value="">Select Type</option>
                                                                    ...
                                                                    <option value="कार्यविधि">कार्यविधि</option>
                                                                    <option value="निर्देशिका">निर्देशिका</option>
                                                                    <option value="मापदण्ड">मापदण्ड</option>
                                                                    <option value="विद्येक">विद्येक</option>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <button type="submit" class="btn btn-lg btn-primary" name="lawdirective">SAVE</button>
