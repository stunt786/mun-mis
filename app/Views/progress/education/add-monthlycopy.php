...
<body class="nk-body ui-rounder npc-default has-sidebar ">
    ...
    <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.0/jquery.min.js" integrity="sha512-3gJwYpMe3QewGELv8k/BX9vcqhryRdzRMxVfq6ngyWXwo03GFEzjsUm8Q7RZcHPHksttq7/GFoxjCVUjkjvPdw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>    window.onload = function() { -->
        ...
        form.action = `/edu/${month.toLowerCase()}`; 
        document.getElementById('selectedMonth').value = month;
        updateMonthTitle(month);
        showForm(month); // Call the showForm function after setting month and updating title
    });
});
function showForm(month) {
    ...
    const formToShow = document.getElementById(month + 'Form'); 
    if (formToShow) {
