                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li class="nk-block-tools-opt">
                                                            <div class="drodown">
                                                                <a href="<?php echo base_url('add-year'); ?>" class="dropdown-toggle btn btn-icon btn-primary" data-bs-toggle="dropdown"><em class="icon ni ni-plus"></em></a>
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                    <?php if (hasPermissions('users_add')): ?>
                                                                        <li><a href="<?php echo base_url('add-year'); ?>"><span>नयाँ आ.ब</span></a></li>
                                                                        <?php endif ?>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                ...
                                                <table class="datatable-init-export nowrap table" data-export-title="Export">
                                                    <thead style="text-align: center;">
                                                        <tr>
                                                            ...
                                                            <th style="width: 50%;">आर्थिक वर्ष</th>
                                                            <th style="width: 20%;">सक्रिय स्थिति</th>
                                                    ...
                                                    <?php foreach ($years as $list) : ?>
                                                        <tr style="text-align: center;">
                                                            <td><?= $list['id'] ?></td>
                                                            <td><?= $list['year'] ?></td>
                                                            <td style="color: <?= $list['active'] == 1 ? 'green' : 'red' ?>;">
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                <?php if (hasPermissions('year_edit')): ?>
                                                                                    <li><a href="<?= base_url('year/edit/' . $list['id']) ?>"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                                    <?php endif ?>
                                                                                    <?php if (hasPermissions('year_delete')): ?>
                                                                                    <li><a href="<?= base_url('year/delete/' . $list['id']) ?>"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                                                    <?php endif ?>
                                                                                    </ul>
                                                                            </div>
                                                                        </div>
