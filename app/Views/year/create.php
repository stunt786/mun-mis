                                            ...
                                            <div class="card-inner">
                                                <form method="post" action="<?php echo base_url('add-year'); ?>" class="form-validate" enctype="multipart/form-data">
                                                    <div class="row g-gs">
                                                        ...
                                                        <!-- <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="form-label" for="active">महिना</label>
                                                                <div class="form-control-wrap ">
                                                                    <select class="form-select js-select2" id="active" name="active" data-placeholder="Select a option" required>
                                                                        <option label="select month" value=""></option>
                                                                        <option value="baishakh">बैशाख</option>
                                                                        <option value="jestha">जेष्ठ</option>
                                                                        <option value="asad">असार</option>
                                                                        <option value="shrawn">श्रावण</option>
                                                                        <option value="bhadra">भाद्र</option>
                                                                        <option value="ashoj">असोज</option>
                                                                        <option value="kartik">कार्तिक</option>
                                                                        <option value="mangsir">मंसीर</option>
                                                                        <option value="poush">पौष</option>
                                                                        <option value="magh">माघ</option>
                                                                        <option value="falgun">फागुन</option>
                                                                        <option value="chaitra">चैत्र</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div> -->
