                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">दर्ता सूचि</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>दर्ता विवरण सूचि</p>
                                            </div>
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li class="nk-block-tools-opt">
                                                            <div class="drodown">
                                                                <a href="<?php echo base_url('add-darta'); ?>" class="dropdown-toggle btn btn-icon btn-primary" data-bs-toggle="dropdown"><em class="icon ni ni-plus"></em></a>
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                    <?php if (hasPermissions('darta_add')): ?>
                                                                        <li><a href="<?php echo base_url('add-darta'); ?>"><span>नयाँ दर्ता</span></a></li>
                                                                        <?php endif ?>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="card-inner">
                                                <table class="datatable-init-export table" data-export-title="Export">
                                                    <thead style="text-align: center;">
                                                        <tr>
                                                            <th style="width: 10%;">दर्ता नं</th>
                                                            <th style="width: 15%;">मिति</th>
                                                            <th style="width: 25%;">विषय</th>
                                                            <th style="width: 20%;">कार्यालय</th>
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    ...
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <?php if (hasPermissions('darta_view')): ?>
                                                                                    <li><a href="<?= base_url('dartachalani/dartaDetails/' . $list['id']) ?>"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
                                                                                    <?php endif ?>
                                                                                    <?php if (hasPermissions('darta_edit')): ?>
                                                                                    <li><a href="<?= base_url('darta/edit/' . $list['id']) ?>"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                                    <?php endif ?>
                                                                                    <?php if (hasPermissions('darta_delete')): ?>
                                                                                    <li><a href="<?= base_url('darta/delete/' . $list['id']) ?>"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                                                    <?php endif ?>
                                                                                    </ul>
                                                                            </div>
                                                                        </div>
