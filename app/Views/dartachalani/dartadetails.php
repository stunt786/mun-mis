                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">दर्ता विवरण</h3>
                                        </div>
                                        <div class="nk-block-head-content">
                                            <a href="<?php echo base_url('list-darta'); ?>" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                                ...
                                                <div class="card-inner">
                                                    <div class="nk-block">
                                                        ...
                                                        <div class="row gy-5">
                                                            ...
                                                            <div class="col-md-3 col-lg-2  col-6">
                                                                <div class="profile-stats">
                                                                    <span class="profile-ud-label">दर्ता मिति</span>
                                                                    <span><?= $detail['received_date'] ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 col-lg-2  col-6">
                                                                <div class="profile-stats">
                                                                    <span class="profile-ud-label">दर्ता नं</span>
                                                            ...
                                                            <div class="col-md-3 col-lg-2  col-6">
                                                                <div class="profile-stats">
                                                                    <span class="profile-ud-label">चलानी</span>
                                                                    <span><?= $detail['chalani'] ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 col-lg-2  col-6">
                                                                <div class="profile-stats">
