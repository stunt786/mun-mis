      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control" name="confirm_password" equalTo="#formClient-Password" id="c" required placeholder="<?php echo lang('App.user_password_confirm') ?>">
          </div>
