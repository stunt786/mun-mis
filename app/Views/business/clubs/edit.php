                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>बाल/युवा क्लब अद्यावधिक फारम</p>
                                            </div>
                                 ...
                                 <div class="card card-bordered">
                                            <div class="card-inner">
                                                <form method="post" action="<?php echo base_url('club/update/' . $clubs['id']); ?>" class="form-validate" enctype="multipart/form-data">
                                                    <div class="row g-gs">
                                                        <div>
                                                            <h6 style="color:red">क्लब दर्ता फारम </h6>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="certno">दर्ता प्रमाणपत्र नं</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="certno" name="certno" value="<?= $clubs['certno'] ?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgname">क्लबको नाम</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="orgname" name="orgname" value="<?= $clubs['orgname'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="estddate">क्लब स्थापना मिति</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="nepali-datepicker" name="estddate" value="<?= $clubs['estddate'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="province">प्रदेश</label>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="district">जिल्ला</label>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="municipality">स्थानीय तह</label>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="ward">वडा</label>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="form-label" for="road">ठेगाना/टोल</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="road" name="road" value="<?= $clubs['road'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="phone" name="phone" value="<?= $clubs['phone'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="email" class="form-control" id="email" name="email" value="<?= $clubs['email'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="pan">पान नम्बर (PAN)</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="pan" name="pan" value="<?= $clubs['pan'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="members">सदस्यको विवरण(अध्यक्ष/सचिब/कोषाध्यक्ष)</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="members" name="members" value="<?= $clubs['members'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="type">क्लब बर्गीकरण</label>
                                                                <div class="form-control-wrap">
                                                                <select class="form-select js-select2" data-search="on" id="type" name="type" data-placeholder="Select an option" required>
                                                                <option value="">Select Type</option>
                                                                <option value="बाल क्लब" <?= $clubs['type'] == 'बाल क्लब' ? 'selected' : '' ?>>बाल क्लब</option>
                                                                <option value="युवा क्लब" <?= $clubs['type'] == 'युवा क्लब' ? 'selected' : '' ?> >युवा क्लब</option>
                                                                <option value="अन्य" <?= $clubs['type'] == 'अन्य' ? 'selected' : '' ?>  >अन्य</option>
                                                                </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="description">क्लबको कार्य विवरण</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="description" name="description" value="<?= $clubs['description'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="applicantname" name="applicantname" value="<?= $clubs['applicantname'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="applicantphone" name="applicantphone" value="<?= $clubs['applicantphone'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="form-label" for="applicantaddr">निवेदकको ठेगाना</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="applicantaddr" name="applicantaddr" value="<?= $clubs['applicantaddr'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="chiefofficer" name="chiefofficer" value="<?= $clubs['chiefofficer'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="chiefofficerjob" name="chiefofficerjob" value="<?= $clubs['chiefofficerjob'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="regdate">क्लब दर्ता मिति</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="regdate" name="regdate" value="<?= $clubs['regdate'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgstatus">क्लब स्थिति</label>
                                                                <div class="form-control-wrap">
                                                                    <select type="text" name="orgstatus" id="orgstatus" class="form-control"  required>
                                                                    <option value="1" <?= $clubs['orgstatus'] == 1 ? 'selected' : '' ?>>संचालनमा रहेको</option>
                                                                    <option value="0" <?= $clubs['orgstatus'] == 0 ? 'selected' : '' ?> >बन्द भएको</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" id="expirydate" name="expirydate" value="<?= $clubs['expirydate'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="renewdate" name="renewdate" value="<?= $clubs['renewdate'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <option value="1" <?= $clubs['expirystatus'] == 1 ? 'selected' : '' ?> >नविकरण भएको</option>
                                                                    <option value="0" <?= $clubs['expirystatus'] == 0 ? 'selected' : '' ?> >नविकरण बाँकी</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <button type="submit" class="btn btn-lg btn-primary" name="clubs">EDIT</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
