                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        ...
                                        <div class="nk-block-head-content">
                                            <a href="<?php echo base_url('club-list'); ?>" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                                        ...
                                                        <div class="profile-ud-list">
                                                                    ...
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            ...
                                                                            <span class="profile-ud-value"><?= $detail['ward'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">कल्बको नाम</span>
                                                                            <span class="profile-ud-value"><?= $detail['orgname'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">क्लब स्थापना मिति</span>
                                                                            <span class="profile-ud-value"><?= $detail['estddate'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">ठेगाना/टोल</span>
                                                                            <span class="profile-ud-value"><?= $detail['road'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            ...
                                                                            <span class="profile-ud-value"><?= $detail['phone'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">इमेल</span>
                                                                            <span class="profile-ud-value"><?= $detail['email'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">PAN नं</span>
                                                                            <span class="profile-ud-value"><?= $detail['pan'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">क्लबको प्रकार</span>
                                                                            <span class="profile-ud-value"><?= $detail['type'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">क्लबको कार्य विवरण</span>
                                                                            <span class="profile-ud-value"><?= $detail['description'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">सदस्यको विवरण(अध्यक्ष/सचिब/कोषाध्यक्ष)</span>
                                                                            <span class="profile-ud-value"><?= $detail['members'] ?></span>
                                                                        </div>
                                                                    </div>
                                                        </div>   
                                                                ...
                                                                <div class="profile-ud-list">
                                                                    ...
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            ...
                                                                            <span class="profile-ud-value"><?= $detail['applicantaddr'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                    ...
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">क्लब दर्ता मिति</span>
                                                                            <span class="profile-ud-value"><?= $detail['regdate'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">क्लब संचालन स्थिति</span>
