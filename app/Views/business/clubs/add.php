                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                 ...
                                 <div class="card card-bordered">
                                            <div class="card-inner">
                                                <form method="post" action="<?= site_url('club') ?>" class="form-validate" enctype="multipart/form-data">
                                                    <div class="row g-gs">
                                                        <div>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="nepali-datepicker" name="estddate" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <option value="बाल क्लब"  >बाल क्लब</option>
                                                                <option value="युवा क्लब"  >युवा कल्ब</option>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="applicantaddr" name="applicantaddr">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgstatus">क्लब संचालन स्थिति</label>
                                                                <div class="form-control-wrap">
                                                                    <select type="text" name="orgstatus" id="orgstatus" class="form-control"  required>
                                                                    <option value="1" selected >संचालनमा रहेको</option>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <button type="submit" class="btn btn-lg btn-primary" name="clubs">SAVE</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
