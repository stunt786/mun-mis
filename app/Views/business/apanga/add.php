                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                 ...
                                 <div class="card card-bordered">
                                            <div class="card-inner">
                                                <form method="post" action="<?= site_url('apanga') ?>" class="form-validate" enctype="multipart/form-data">
                                                    <div class="row g-gs">
                                                        <div>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="nepali-datepicker" name="reg_date" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select js-select2" data-search="on" id="disability_type" name="disability_type" data-placeholder="Select an option" required>
                                                                    ...
                                                                    <option value="क">क बर्ग</option>
                                                                    <option value="ख">ख बर्ग</option>
                                                                    <option value="ग">ग बर्ग</option>
                                                                    <option value="घ">घ बर्ग</option>
                                                                    <option value="अन्य" >अन्य</option>
                                                                </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="disability_description" name="disability_description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select js-select2" data-search="on" id="disability_reason" name="disability_reason" data-placeholder="Select an option" required>
                                                                    ...
                                                                    <option value="रोगको दिर्घ असर">रोगको दिर्घ असर</option>
                                                                    <option value="दुर्घटना">दुर्घटना</option>
                                                                    <option value="जन्मजात">जन्मजात</option>
                                                                    <option value="सशत्र द्धन्द">सशत्र द्धन्द</option>
                                                                    <option value="वंसाणुगत" >वंसाणुगत</option>
                                                                    <option value="अन्य" >अन्य</option>
                                                                </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select js-select2" data-search="on" id="people_need" name="people_need" data-placeholder="Select an option">
                                                                    <option value="">Select Type</option>
                                                                    <option value="1">चाहिने</option>
                                                                    <option value="0">नचाहिने</option>
                                                                </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="people_need_desc" name="people_need_desc" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                <input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" id="ereg_date" name="ereg_date" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="ebirth_date" name="ebirth_date" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="eprovince" name="eprovince" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="edistrict" name="edistrict" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="emunicipality" name="emunicipality" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="eward" name="eward" required>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="efather" name="efather" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="emother" name="emother">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="eguardian" name="eguardian">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select js-select2" data-search="on" id="edisability_type" name="edisability_type" data-placeholder="Select an option" required>
                                                                    <option value="">Select Type</option>
                                                                    <option value="KA">Ka Barga</option>
                                                                    <option value="KHA">Kha Barga</option>
                                                                    <option value="GA">Ga Barga</option>
                                                                    <option value="GHA">Gha Barga</option>
                                                                    <option value="Other" >Other</option>
                                                                </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="father1" name="father1" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="echiefofficer" name="echiefofficer" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="echiefofficerjob" name="echiefofficerjob" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">    
