                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">उद्योग व्यवशाय प्रकृति</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>Business Category Records</p>
                                            </div>
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li class="nk-block-tools-opt">
                                                            <div class="drodown">
                                                                <a href="<?php echo base_url('add-buscategory'); ?>" class="dropdown-toggle btn btn-icon btn-primary" data-bs-toggle="dropdown"><em class="icon ni ni-plus"></em></a>
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                    <?php if (hasPermissions('buscat_add')): ?>
                                                                        <li><a href="<?php echo base_url('add-buscat'); ?>"><span>नयाँ प्रकृति</span></a></li>
                                                                        <?php endif ?>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                ...
                                                <table class="datatable-init-export nowrap table" data-export-title="Export">
                                                    <thead style="text-align: center;">
                                                        <tr>
                                                            ...
                                                            <th style="width: 50%;">व्यवशाय प्रकृति</th>
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                <?php if (hasPermissions('buscat_edit')): ?>
                                                                                    <li><a href="<?= base_url('buscat/edit/' . $list['id']) ?>"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                                    <?php endif ?>
                                                                                    <?php if (hasPermissions('buscat_delete')): ?>
                                                                                    <li><a href="<?= base_url('buscat/delete/' . $list['id']) ?>"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                                                    <?php endif ?>
                                                                                    </ul>
                                                                            </div>
                                                                        </div>
