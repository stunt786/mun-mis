    ...
    <div id='print'>
        ...
        <div class="col-md-10">
            <div style="text-align: center;">
                <img src="<?= base_url('assets/images/img/logo.png'); ?>" height="100px" width="480px" style="float:centre" id="image">
