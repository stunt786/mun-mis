                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        ...
                                        <div class="nk-block-head-content">
                                            <a href="<?php echo base_url('samuha-list'); ?>" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                                ...
                                                <div class="card-inner">
                                                    <div class="nk-block">
                                                        ...
                                                        <div class="profile-ud-list">
                                                                    ...
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">समुहको नाम</span>
                                                                            <span class="profile-ud-value"><?= $detail['orgname'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">समुह स्थापना मिति</span>
                                                                    ...
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">समुहको बर्गीकरण</span>
                                                                            <span class="profile-ud-value"><?= $detail['orgtype'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">समुहको कार्य विवरण</span>
                                                            ...
                                                            <div class="profile-ud-list">
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">म.बा.जे.ना शाखा प्रमुख</span>
                                                                            <span class="profile-ud-value"><?= $detail['branchofficer'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">म.बा.जे.ना शाखा प्रमुख पद</span>
                                                                ...
                                                                <div class="profile-ud-list">
                                                                    ...
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">समुह दर्ता मिति</span>
                                                                            <span class="profile-ud-value"><?= $detail['orgregdate'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="profile-ud-item">
                                                                        <div class="profile-ud wider">
                                                                            <span class="profile-ud-label">समुह संचालन स्थिति</span>
