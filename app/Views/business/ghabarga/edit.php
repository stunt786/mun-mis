                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>निर्माण व्यवशाय अद्यावधिक फारम</p>
                                            </div>
                                 ...
                                 <div class="card card-bordered">
                                            <div class="card-inner">
                                                <form method="post" action="<?php echo base_url('ghabarga/update/' . $ghabarga['id']); ?>" class="form-validate" enctype="multipart/form-data">
                                                    <div class="row g-gs">
                                                        <div>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="cert_no" name="cert_no" value="<?= $ghabarga['cert_no'] ?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="orgname" name="orgname" value="<?= $ghabarga['orgname'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="nepali-datepicker" name="orgestddate" value="<?= $ghabarga['orgestddate'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="orgroad" name="orgroad" value="<?= $ghabarga['orgroad'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="orgphone" name="orgphone" value="<?= $ghabarga['orgphone'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="email" class="form-control" id="orgemail" name="orgemail" value="<?= $ghabarga['orgemail'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="orgpan" name="orgpan" value="<?= $ghabarga['orgpan'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <option value="प्राइभेट लिमिटेड कम्पनी" <?= $ghabarga['orgtype'] == 'प्राइभेट लिमिटेड कम्पनी' ? 'selected' : '' ?>>प्राइभेट लिमिटेड कम्पनी</option>
                                                                <option value="पब्लिक लिमिटेड कम्पनी" <?= $ghabarga['orgtype'] == 'पब्लिक लिमिटेड कम्पनी' ? 'selected' : '' ?>>पब्लिक लिमिटेडकम्पनी</option>
                                                                <option value="एकलौटी" <?= $ghabarga['orgtype'] == 'एकलौटी' ? 'selected' : '' ?>>एकलौटी</option>
                                                                <option value="साझेदारी" <?= $ghabarga['orgtype'] == 'साझेदारी' ? 'selected' : '' ?>>साझेदारी</option>
                                                                </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <option value="">Select Type</option>
                                                                <option value="घ" <?= $ghabarga['barga'] == 'घ' ? 'selected' : '' ?>>घ</option>
                                                                <option value="अन्य" <?= $ghabarga['barga'] == 'अन्य' ? 'selected' : '' ?>>अन्य</option>
                                                                </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="maxcapital" name="maxcapital" value="<?= $ghabarga['maxcapital'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="currentcapital" name="currentcapital" value="<?= $ghabarga['currentcapital'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="ogroup" name="ogroup" value="<?= $ghabarga['ogroup'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="overdraftcapital" name="overdraftcapital" value="<?= $ghabarga['overdraftcapital'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="mudatiaccount" name="mudatiaccount" value="<?= $ghabarga['mudatiaccount'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="currentaccount" name="currentaccount" value="<?= $ghabarga['currentaccount'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="savingaccount" name="savingaccount" value="<?= $ghabarga['savingaccount'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="skilledemployee" name="skilledemployee" value="<?= $ghabarga['skilledemployee'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="unskilledemployee" name="unskilledemployee" value="<?= $ghabarga['unskilledemployee'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="otheremployee" name="otheremployee" value="<?= $ghabarga['otheremployee'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <textarea class="form-control form-control-sm" id="vehicleslist" name="vehicleslist"><?= $ghabarga['vehicleslist'] ?></textarea>  
                                                            </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="applicantname" name="applicantname" value="<?= $ghabarga['applicantname'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="applicantaddress" name="applicantaddress" value="<?= $ghabarga['applicantaddress'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="applicantphone" name="applicantphone" value="<?= $ghabarga['applicantphone'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="email" class="form-control" id="applicantemail" name="applicantemail" value="<?= $ghabarga['applicantemail'] ?>" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="chiefofficer" name="chiefofficer" value="<?= $ghabarga['chiefofficer'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="chiefofficerjob" name="chiefofficerjob" value="<?= $ghabarga['chiefofficerjob'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="orgregdate" name="orgregdate" value="<?= $ghabarga['orgregdate'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <option value="1" <?= $ghabarga['orgstatus'] == 1 ? 'selected' : '' ?>>संचालनमा रहेको</option>
                                                                    <option value="0" <?= $ghabarga['orgstatus'] == 0 ? 'selected' : '' ?> >बन्द भएको</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" id="expirydate" name="expirydate" value="<?= $ghabarga['expirydate'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="renewdate" name="renewdate" value="<?= $ghabarga['renewdate'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <option value="1" <?= $ghabarga['expirystatus'] == 1 ? 'selected' : '' ?> >नविकरण भएको</option>
                                                                    <option value="0" <?= $ghabarga['expirystatus'] == 0 ? 'selected' : '' ?> >नविकरण बाँकी</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
