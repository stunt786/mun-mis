                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>व्यवशाय दर्ता फारम भर्नुहोस</p>
                                            </div>
                                 ...
                                 <div class="card card-bordered">
                                            <div class="card-inner">
                                                <form method="post" action="<?= site_url('bewosaye') ?>" class="form-validate" enctype="multipart/form-data">
                                                    <div class="row g-gs">
                                                        <div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_name">व्यवशाय/फर्मको नाम</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="fiscal_year">आर्थिक वर्ष</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_established_nep_date">व्यवशाय स्थापना मिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_province_id">प्रदेश</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_district_id">जिल्ला</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_municipality_id">स्थानीय तह</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_ward_id">वडा नं</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_road_name">ठेगाना/टोल</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_house_no" name="org_house_no">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_phone">सम्पर्क नं</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_type">व्यवशाय बर्गीकरण</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_type_description">व्यवशाय कारोवार विवरण</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_total_capital">पुजिगत लगानी</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="org_total_capital" name="org_total_capital" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_ownership">व्यवशाय प्रकृति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_land_kitta_no" name="org_land_kitta_no">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="boardsize" name="boardsize">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="prop_name">संचालकको नाम</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="prop_phone">संचालकको सम्पर्क नं</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="prop_phone" name="prop_phone" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="prop_road_name">संचालकको ठेगाना</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="prop_road_name" name="prop_road_name" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="prop_ctzn_no">संचालकको नागरिकता नं.</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="prop_ctzn_no" name="prop_ctzn_no" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="prop_ctzn_district">ना.प्र.प.जारी जिल्ला</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="prop_ctzn_district" name="prop_ctzn_district" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="prop_ctzn_date">ना.प्र.प.जारी मिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="nepali-datepicker-send-date" name="prop_ctzn_date" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="fv-full-file2">संचालकको फोटो</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div>
                                                            ...
                                                            <label style="color: green;">संचालक नै घर धनी हो</label>
                                                            <input type="checkbox" id="fill_checkbox">
                                                        </div>

                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_house_owner">घरधनिको नाम</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_house_owner" name="org_house_owner" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_house_owner_address">घरधनिको ठेगाना</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_house_owner_address" name="org_house_owner_address" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_house_owner_phone" name="org_house_owner_phone">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_house_rent" name="org_house_rent">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <label style="color:green">संचालक नै निवेदक हो </label>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="org_reg_date">व्यवशाय दर्ता मिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                <label class="form-label" for="status">व्यवशाय संचालन स्थिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="expiry_date">नविकरण बहाल रहने मिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="renew_date">अन्तिम नविकरण मिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                <label class="form-label" for="expiry_status">नविकरण स्थिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="chief_officer" name="chief_officer">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <button type="submit" class="btn btn-lg btn-primary" name="business">SAVE</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
