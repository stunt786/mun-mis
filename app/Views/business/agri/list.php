                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title"><?= $title ?> विवरण</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>जम्मा कृषि/पशु समुह विवरण</p>
                                            </div>
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li class="nk-block-tools-opt">
                                                            <div class="drodown">
                                                                <a href="<?php echo base_url('add-agri'); ?>" class="dropdown-toggle btn btn-icon btn-primary" data-bs-toggle="dropdown"><em class="icon ni ni-plus"></em></a>
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                    <?php if (hasPermissions('agri_add')): ?>
                                                                        <li><a href="<?php echo base_url('add-agri'); ?>"><span>नयाँ विवरण</span></a></li>
                                                                        <?php endif ?>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    ...
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <?php if (hasPermissions('agri_view')): ?>
                                                                                    <li><a href="<?= base_url('agri/agriDetails/' . $list['id']) ?>"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
                                                                                    <?php endif ?>
                                                                                    <?php if (hasPermissions('agri_edit')): ?>
                                                                                    <li><a href="<?= base_url('agri/edit/' . $list['id']) ?>"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                                    <?php endif ?>
                                                                                    <?php if (hasPermissions('agri_delete')): ?>
                                                                                    <li><a href="<?= base_url('agri/delete/' . $list['id']) ?>"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                                                    <?php endif ?>
                                                                                    <?php if (hasPermissions('agri_print')): ?>
                                                                                    <li><a href="<?= base_url('agri/print/' . $list['id']) ?>" target="_blank"><em class="icon ni ni-printer"></em><span>Print</span></a></li>
                                                                                    <?php endif ?>
                                                                                    </ul>
                                                                            </div>
                                                                        </div>
