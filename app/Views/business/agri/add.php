                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                 ...
                                 <div class="card card-bordered">
                                            <div class="card-inner">
                                                <form method="post" action="<?= site_url('agri') ?>" class="form-validate" enctype="multipart/form-data">
                                                <?php echo form_open_multipart('agri', [ 'class' => 'form-validate', 'autocomplete' => 'off' ]); ?>

                                                    <div class="row g-gs">
                                                        <div>
                                                            <h6 style="color:red">कृषि/पशु समुह दर्ता फारम </h6>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="certno">दर्ता प्रमाणपत्र नं</label><em style="color:red">*</em>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgname">समूहको नाम</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="fiscalyear">आर्थिक वर्ष</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgestablishednepdate">समुह स्थापना मिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgprovinceid">प्रदेश</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgdistrictid">जिल्ला</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgmunicipalityid">स्थानीय तह</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgwardid">वडा</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgroadname">ठेगाना/टोल</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgphone">सम्पर्क नं</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgemail">इमेल</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgmembers">सदस्यको विवरण(अध्यक्ष/सचिब/कोषाध्यक्ष)</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="orgmembers" name="orgmembers"required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgtype">समुह बर्गीकरण</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                                ...
                                                                <option value="कृषि समुह"  >कृषि समुह</option>
                                                                <option value="कृषि फार्म"  >कृषि फार्म</option>
                                                                <option value="पशु समुह"  >पशु समुह</option>
                                                                <option value="पशु-पंछि फार्म"  >पशु-पंछि फार्म</option>
                                                                <option value="कृषि तथा पशु-पंछि समुह"  >कृषि तथा पशु-पंछि समुह</option>
                                                                <option value="पशु क्षेत्र विकाश समुह"  >पशु क्षेत्र विकाश समुह</option>
                                                                </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgtypedescription">समुह/फर्म कार्य विवरण</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="form-label" for="applicantname">निवेदकको नाम</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="form-label" for="applicantphone">निवेदकको फोन नं</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="branchofficer">कृषि/पशु शाखा प्रमुख</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="branchofficerjob">कृषि/पशु शाखा प्रमुख पद</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="chiefofficer">कार्यालय प्रमुख</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="chiefofficerjob">कार्यालय प्रमुख पद</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgregdate">समुह दर्ता मिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                <label class="form-label" for="orgstatus">समूह संचालन स्थिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="expirydate">नविकरण बहाल रहने मिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="renewdate">अन्तिम नविकरण मिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                <label class="form-label" for="expirystatus">नविकरण स्थिति</label><em style="color:red">*</em>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <button type="submit" class="btn btn-lg btn-primary" name="agri">SAVE</button>
