                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                 ...
                                 <div class="card card-bordered">
                                            <div class="card-inner">
                                                <form method="post" action="<?php echo base_url('sahakari/update/' . $sahakari['id']); ?>" class="form-validate" enctype="multipart/form-data">
                                                    <div class="row g-gs">
                                                        <div>
                                                            <h6 style="color:red">सहकारी विवरण</h6>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="cert_no">दर्ता प्रमाणपत्र नं</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="cert_no" name="cert_no" value="<?= $sahakari['cert_no'] ?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_name" name="org_name" value="<?= $sahakari['org_name'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                <select class="form-select js-select2" id="fiscal_year" name="fiscal_year" data-placeholder="Select an option" value="<?= $sahakari['cert_no'] ?>" required>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="nepali-datepicker" name="org_established_nep_date" value="<?= $sahakari['org_established_nep_date'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_road_name" name="org_road_name" value="<?= $sahakari['org_road_name'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_phone" name="org_phone" value="<?= $sahakari['org_phone'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="email" class="form-control" id="org_email" name="org_email" value="<?= $sahakari['org_email'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_pan" name="org_pan" value="<?= $sahakari['org_pan'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <option value="">Select Type</option>
                                                                    <option value="बहुउदेश्यीय संस्था" <?= $sahakari['org_type'] == 'बहुउदेश्यीय संस्था' ? 'selected' : '' ?>>बहुउदेश्यीय संस्था</option>
                                                                    <option value="कृषि संस्था" <?= $sahakari['org_type'] == 'कृषि संस्था' ? 'selected' : '' ?>>कृषि संस्था</option>
                                                                    <option value="श्रमिक संस्था" <?= $sahakari['org_type'] == 'श्रमिक संस्था' ? 'selected' : '' ?>>श्रमिक संस्था</option>
                                                                    <option value="उपभोक्ता संस्था" <?= $sahakari['org_type'] == 'उपभोक्ता संस्था' ? 'selected' : '' ?>>उपभोक्ता संस्था</option>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_type_description" name="org_type_description" value="<?= $sahakari['org_type_description'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_dayewto" name="org_dayewto" value="<?= $sahakari['org_dayewto'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="org_work_area" name="org_work_area" value="<?= $sahakari['org_work_area'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="org_members" name="org_members" value="<?= $sahakari['org_members'] ?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="org_male" name="org_male" value="<?= $sahakari['org_male'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="org_female" name="org_female" value="<?= $sahakari['org_female'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="org_share_capital" name="org_share_capital" value="<?= $sahakari['org_share_capital'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="org_entry_capital" name="org_entry_capital" value="<?= $sahakari['org_entry_capital'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="form-label" for="fv-full-file1">कागजात</label>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="applicant_name" name="applicant_name" value="<?= $sahakari['applicant_name'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="applicant_phone" name="applicant_phone" value="<?= $sahakari['applicant_phone'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="applicant_address" name="applicant_address" value="<?= $sahakari['applicant_address'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" id="org_reg_date" name="org_reg_date" value="<?= $sahakari['org_reg_date'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <option value="1" <?= $sahakari['status'] == 1 ? 'selected' : '' ?>>संचालनमा रहेको</option>
                                                                    <option value="0" <?= $sahakari['status'] == 0 ? 'selected' : '' ?> >बन्द भएको</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" id="expiry_date" name="expiry_date" value="<?= $sahakari['expiry_date'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="renew_date" name="renew_date" value="<?= $sahakari['renew_date'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <option value="1" <?= $sahakari['expiry_status'] == 1 ? 'selected' : '' ?> >नविकरण भएको</option>
                                                                    <option value="0" <?= $sahakari['expiry_status'] == 0 ? 'selected' : '' ?> >नविकरण बाँकी</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="chief_officer" name="chief_officer" value="<?= $sahakari['chief_officer'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="chief_officer_job" name="chief_officer_job" value="<?= $sahakari['chief_officer_job'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control form-control-sm" id="remarks" name="remarks" placeholder="Write Remarks" value="<?= $sahakari['remarks'] ?>" ></textarea> 
                                                            </div>
                                                        </div>
