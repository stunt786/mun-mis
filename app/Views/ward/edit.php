                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">वडा कार्यालय अद्यावधिक</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>Edit Ward Office</p>
                                            </div>
                                ...
                                <div class="card card-bordered">
                                            <div class="card-inner">
                                                <form method="post" action="<?php echo base_url('ward/update/' . $ward['id']); ?>" class="form-validate" enctype="multipart/form-data">
                                                    <div class="row g-gs">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="fv-full-ward">वडा नं</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="ward" name="ward" value="<?= $ward['ward'] ?>" required>
                                                                    <?= form_error('ward') ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap ">
                                                                    <select class="form-select js-select2" id="status" name="status" data-placeholder="Select a option" required>
                                                                        ...
                                                                        <option value="1" <?= $ward['status'] == 1 ? 'selected' : '' ?>>सक्रिय</option>
                                                                        <option value="0" <?= $ward['status'] == 0 ? 'selected' : '' ?>>निष्क्रिय</option>
